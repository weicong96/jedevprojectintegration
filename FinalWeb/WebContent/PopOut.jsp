...
<html lang="en">
<head>
    <title id='Description'>The jqxWindow provides keyboard navigation once it gains focus(either programmatically or as a result of a user click). When the widget is focused, you can use the keyboard to change its position and size.</title>
...
<body class='default'>
    <div style="visibility: hidden;" id="jqxWidget">
        ...
        <div id="window">
            <div>
                Consultation Slots Details
            </div>
            <div>
                <div>
                    <img src="images/Consultation.jpg" alt="" class="big-image" />
                    <div>
