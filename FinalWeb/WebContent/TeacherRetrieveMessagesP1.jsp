...
ArrayList<Conversation> convoList = dbao.retrieveConversationGroup(staffCode);
...
<div id='body'>
<form action="TeacherRetrieveMessages" action="GET">
<table align="center">
<%=staffCode%>
<%=convoList.size()%>
<tr><th style="width:900px">Welcome, <%=username%></th><td><a href="login.jsp"><input type="button" value="Logout"></a></td></tr>
</table>
<h1 align="center">Choose Conversation</h1>
<table align="center">
<tr><%for(int i=0; i<convoList.size(); i++){ %><td style="width:100px">
<input type="radio" name="ConvoName" class="grpName" value="<%=convoList.get(i).getGroup_teamCode()%>"><%=convoList.get(i).getGroup_teamCode()%></input>
<%} %></td></tr>
</table>
<br>
<br>
