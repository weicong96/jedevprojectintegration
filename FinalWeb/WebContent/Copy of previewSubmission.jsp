...
<body>
	...
	<div id='body' class="container-fluid">
		...
		<ex:isNull entity="${sub}" property="compiled">
			...
			<a href="DownloadSubmission?id=${sub[submissionID]}">Download Android Application</a>
			</div>
		</ex:isNull>
		...
		<div id="screenshots">
			...
			<h2 class="col-xs-12">Screenshots</h2>
				<div style="width:100%;">
				<c:forTokens items="${sub.screenshot}" delims="," var="screenshotSingle">
						<img class="col-xs-3" src="files/screenshot/${sub.name}_${screenshotSingle}"/>
				 </c:forTokens>
				 </div>	
			</div>
		</div>
		...
		<div id="video">
			...
			<video width="640" height="480" controls>
			  <source src="files/video/${sub.name}_${sub.video}">
