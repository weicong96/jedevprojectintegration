...
<html>
	<head>
		<title>Delete Consultation Slots</title>
...
<form action="RetrieveBookingServlet" method="GET">
<div id='body'>

<table align="center">
<tr><td align="center"><h1>Delete Consultation Slots</h1></td></tr>
</table>
...
<tr><th style="width:120px">Room No</th><th style="width:120px">Book Date</th><th style="width:120px">Start Time</th><th style="width:120px">Group Coming</th><th style="width:120px">Teacher on Duty</th><th></th></tr>
<%if(request.getParameter("datepicker")==null && request.getParameter("roomNo")==null){%>
<%for (int i=0; i<bookingList.size(); i++){%>
<tr><td><%=bookingList.get(i).getBookVenue()%></td><td><%=bookingList.get(i).getBookDate()%></td><td><%=bookingList.get(i).getBookTime()%></td>
		<td><%=bookingList.get(i).getFk_groupCode()%>
		</td>
...
<% } else{%>
<%for (int i=0; i<booklist.size(); i++){%><tr><td><%=booklist.get(i).getBookVenue()%></td><td><%=booklist.get(i).getBookDate()%></td><td><%=booklist.get(i).getBookTime()%></td><td><%=booklist.get(i).getFk_groupCode()%></td><td><%=booklist.get(i).getFk_staffID()%></td></tr>
<%}}%>
</table>
<br>
